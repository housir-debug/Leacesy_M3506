...
private:
    ...
    // -
    static scpi_result_t SCPI_SettingImpedanceQ(scpi_t* context)     {return sendQueryCmd(context,0x02,0x82);};
    static scpi_result_t SCPI_SettingVoltQ(scpi_t* context)          {return sendQueryCmd(context,0x02,0x80);};
    static scpi_result_t SCPI_SettingCurrQ(scpi_t* context)          {return sendQueryCmd(context,0x02,0x81);};
    static scpi_result_t SCPI_SettingProtQ(scpi_t* context)          {return sendQueryCmd(context,0x02,0x83);};
    static scpi_result_t SCPI_SettingTherQ(scpi_t* context)          {return sendQueryCmd(context,0x02,0x84);};
    static scpi_result_t SCPI_SettingLoadQ(scpi_t* context)          {return sendQueryCmd(context,0x02,0x85);};
    // --- Control ------------------------------------------------------------------------------
    ...
    // -
    static scpi_result_t SCPI_MeasureVoltQ(scpi_t* context)          {return sendQueryCmd(context,0x04,0x80);};
    static scpi_result_t SCPI_MeasureCurrQ(scpi_t* context)          {return sendQueryCmd(context,0x04,0x81);};
    static scpi_result_t SCPI_MeasureScurQ(scpi_t* context)          {return sendQueryCmd(context,0x04,0x82);};
    static scpi_result_t SCPI_MeasureBtmpQ(scpi_t* context)          {return sendQueryCmd(context,0x04,0x83);};
    static scpi_result_t SCPI_MeasureHtmpQ(scpi_t* context)          {return sendQueryCmd(context,0x04,0x84);};
    static scpi_result_t SCPI_MeasureAcdcQ(scpi_t* context)          {return sendQueryCmd(context,0x04,0x85);};
    static scpi_result_t SCPI_MeasureDvmQ(scpi_t* context)           {return sendQueryCmd(context,0x04,0x86);};
    static scpi_result_t SCPI_MeasureFanQ(scpi_t* context)           {return sendQueryCmd(context,0x04,0x87);};
    static scpi_result_t SCPI_MeasureDutyQ(scpi_t* context)          {return sendQueryCmd(context,0x04,0x9d);};
    static scpi_result_t SCPI_MeasureDvmacQ(scpi_t* context)         {return sendQueryCmd(context,0x04,0x89);};
    static scpi_result_t SCPI_MeasureTemp1Q(scpi_t* context)         {return sendQueryCmd(context,0x04,0x8a);};
    static scpi_result_t SCPI_MeasureTemp2Q(scpi_t* context)         {return sendQueryCmd(context,0x04,0x8b);};
    static scpi_result_t SCPI_MeasureTemp3Q(scpi_t* context)         {return sendQueryCmd(context,0x04,0x8d);};
    static scpi_result_t SCPI_MeasureAdofVoltQ(scpi_t* context)      {return sendQueryCmd(context,0x04,0xb0);};
    static scpi_result_t SCPI_MeasureAdofCurrQ(scpi_t* context)      {return sendQueryCmd(context,0x04,0xb1);};
    static scpi_result_t SCPI_MeasureAdofScurQ(scpi_t* context)      {return sendQueryCmd(context,0x04,0xb2);};
    static scpi_result_t SCPI_MeasureAdofDvmQ(scpi_t* context)       {return sendQueryCmd(context,0x04,0xb6);};
    ...
    static scpi_result_t SCPI_MeasureCurrMinQ(scpi_t* context)       {return sendQueryCmd(context,0x04,0x94);};
    static scpi_result_t SCPI_MeasureDvmHighQ(scpi_t* context)       {return sendQueryCmd(context,0x04,0x95);};
    static scpi_result_t SCPI_MeasureDvmLowQ(scpi_t* context)        {return sendQueryCmd(context,0x04,0x96);};
    static scpi_result_t SCPI_MeasureDvmMaxQ(scpi_t* context)        {return sendQueryCmd(context,0x04,0x97);};
    static scpi_result_t SCPI_MeasureDvmMinQ(scpi_t* context)        {return sendQueryCmd(context,0x04,0x98);};
    static scpi_result_t SCPI_MeasureVoltHighQ(scpi_t* context)      {return sendQueryCmd(context,0x04,0x99);};
    static scpi_result_t SCPI_MeasureVoltLowQ(scpi_t* context)       {return sendQueryCmd(context,0x04,0x9a);};
    ...
    // -
    static scpi_result_t SCPI_RegisterEvenQ(scpi_t* context)         {return sendQueryCmd(context,0x05,0x80);};
    static scpi_result_t SCPI_RegisterEnabQ(scpi_t* context)         {return sendQueryCmd(context,0x05,0x81);};
    static scpi_result_t SCPI_RegisterCondQ(scpi_t* context)         {return sendQueryCmd(context,0x05,0x82);};
    static scpi_result_t SCPI_RegisterNextQ(scpi_t* context)         {return sendQueryCmd(context,0x05,0x83);};
    // --- Calibrate ----------------------------------------------------------------------------
    ...
    static std::vector<ChannelAddress> parseChannelList(scpi_t* context);

    static scpi_result_t sendMultiCHCmd(scpi_t* context, quint8 cmd, quint8 func, const QByteArray &data, const std::vector<ChannelAddress> &channels);
    static scpi_result_t sendSingleCHCmd(scpi_t* context, quint8 cmd, quint8 func, const QByteArray &data);
    static scpi_result_t sendAllCHCmd(scpi_t* context, quint8 cmd, quint8 func, const QByteArray &data);
